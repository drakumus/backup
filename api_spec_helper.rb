...
require_relative 'swagger_definer.rb'
require_relative '../path_definition_store'

$poc = SwaggerDefiner.new
...
def raw_api_call(method, path, params, body_params = {}, headers = {}, opts = {})
  ...
  enable_forgery_protection do
    ...
    # hook for swagger definition generation
    $poc.parse_response(path, method, response.code, body_params, JSON.parse(response.body))
    PathDefinitionStore::update_path_definitions($poc)
    response
  end
end
